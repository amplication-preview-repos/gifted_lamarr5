...
import { CarpoolGroupFindManyArgs } from "../../carpoolGroup/base/CarpoolGroupFindManyArgs";
import { CarpoolGroup } from "../../carpoolGroup/base/CarpoolGroup";
...
export class AccountControllerBase {
  ...
  async findCarpoolGroups(
    ...
    const query = plainToClass(CarpoolGroupFindManyArgs, request.query);
    const results = await this.service.findCarpoolGroups(params.id, {
      ...query,
      select: {
        id: true,
        createdAt: true,
  ...
  @common.Post("/:id/carpoolGroups")
  @nestAccessControl.UseRoles({
    resource: "Account",
    action: "update",
    possession: "any",
  })
  async connectCarpoolGroups(
    @common.Param() params: AccountWhereUniqueInput,
    @common.Body() body: CarpoolGroupWhereUniqueInput[]
  ): Promise<void> {
    const data = {
      carpoolGroups: {
        connect: body,
  ...
  @common.Patch("/:id/carpoolGroups")
  @nestAccessControl.UseRoles({
    resource: "Account",
    action: "update",
    possession: "any",
  })
  async updateCarpoolGroups(
    @common.Param() params: AccountWhereUniqueInput,
    @common.Body() body: CarpoolGroupWhereUniqueInput[]
  ): Promise<void> {
    const data = {
  ...
  @common.Delete("/:id/carpoolGroups")
  @nestAccessControl.UseRoles({
    resource: "Account",
    action: "update",
    possession: "any",
  })
  async disconnectCarpoolGroups(
    @common.Param() params: AccountWhereUniqueInput,
    @common.Body() body: CarpoolGroupWhereUniqueInput[]
  ): Promise<void> {
    const data = {
